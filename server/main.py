...
#    dict(slidingWindow=[2,5,10,30],slidingWindowCoverage=300,nHeads=8,nLayers=3),
 #   dict(slidingWindow=[2,5,10,30],slidingWindowCoverage=300,nHeads=8,nLayers=6),
 ...
 #   dict(slidingWindow=[2,30],slidingWindowCoverage=30,nHidden=50,nLayers=5),
    dict(slidingWindow=[2,30],slidingWindowCoverage=15,nHidden=100,nLayers=5),
...
if __name__=='__main__':
    for i,ba in enumerate( batch ):
        ...
        #trainLosses, model=trainer.trainModel( "transformer",batchSize=1024,nEpochs=80,slidingWindow=ba["slidingWindow"],slidingWindowCoverage=ba["slidingWindowCoverage"],nHeads=ba["nHeads"],nLayers=ba["nLayers"],nInputs=14 )
