...
#    dict(slidingWindow=[2,30],slidingWindowCoverage=30,nHidden=50,nLayers=3),
    dict(slidingWindow=[2,30],slidingWindowCoverage=30,nHeads=8,nLayers=6,dModel=128),
    dict(slidingWindow=[2,30],slidingWindowCoverage=30,nHeads=8,nLayers=3,dModel=512),
    dict(slidingWindow=[2,30],slidingWindowCoverage=60,nHeads=8,nLayers=6,dModel=1000)
...
if __name__=='__main__':
    for i,ba in enumerate( batch ):
        ...
        trainLosses, model=trainer.trainModel( "transformer",batchSize=1024,nEpochs=30,dModel=ba["dModel"],slidingWindow=ba["slidingWindow"],slidingWindowCoverage=ba["slidingWindowCoverage"],nHead=ba["nHeads"],nLayers=ba["nLayers"],nInputs=10 )
