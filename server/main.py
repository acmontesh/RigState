...
if __name__=='__main__':
    for i,ba in enumerate( batch ):
        ...
        trainLosses, model=trainer.trainModel( "transformer",batchSize=512,nEpochs=40,slidingWindow=ba["slidingWindow"],slidingWindowCoverage=ba["slidingWindowCoverage"],nHeads=ba["nHeads"],nLayers=ba["nLayers"],nInputs=10 )
