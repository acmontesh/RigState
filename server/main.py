...
if __name__=='__main__':
    for i,ba in enumerate( batch ):
        ...
        trainLosses, model=trainer.trainModel( "conv_transformer",batchSize=1024,nEpochs=80,slidingWindow=ba["slidingWindow"],slidingWindowCoverage=ba["slidingWindowCoverage"],nHeads=ba["nHeads"],nLayers=ba["nLayers"],nInputs=14 )
